...
================================================== -->
	...
	<div class="card-columns listfeaturedtag">
		...
		<div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" style="background-image:url({{asset('assets/img/demopic/2.jpg')}});">
						</div>
					</a>
				</div>
				<div class="col-md-7">
		...
		<div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" style="background-image:url({{asset('assets/img/demopic/3.jpg')}});">
						</div>
					</a>
				</div>
				<div class="col-md-7">
		...
		<div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" style="background-image:url({{asset('assets/img/demopic/4.jpg')}});">
						</div>
					</a>
				</div>
				<div class="col-md-7">
	...
	<div class="card-columns listrecent">
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/5.jpg')}}" alt="">
			</a>
			<div class="card-block">
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/6.jpg')}}" alt="">
			</a>
			<div class="card-block">
...
{{-- <h1>salom</h1> --}}
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/7.jpg')}}" alt="">
			</a>
			<div class="card-block">
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/8.jpg')}}" alt="">
			</a>
			<div class="card-block">
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/9.jpg')}}" alt="">
			</a>
			<div class="card-block">
		...
		<div class="card">
			<a href="post.html">
				<img class="img-fluid" src="{{asset('assets/img/demopic/10.jpg')}}" alt="">
			</a>
			<div class="card-block">
