...
@section('content')
    ...
    <div class="container">
        <h1 class="text text-primary text-center  mb-0 mt-3">Yangi birnarsa yaratish</h1>
        <div class="d-flex">
            @if($errors->any())
                ...
                @endforeach
            @endif
            <form method="post" action="{{route('test2.store')}}" enctype="multipart/form-data" class="w-100 m-3 mt-0 p-5" >
                @csrf
                <div class="mb-3">
