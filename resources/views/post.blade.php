        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            <div class="mainheading">
                ...
                <div class="row post-top-meta">
                    ...
                    <div class="col-md-10">
                        <a class="link-dark" href="">{{$post->avtor->name}}</a><a href="#" class="btn follow">Follow</a>
                        ...
                        <span class="post-date">{{$post->created_at}}</span><span class="dot"></span><span class="post-read">6 min read</span>
                    </div>
                </div>
                <!-- End Top Menta -->
            ...
            <img class="featured-image img-fluid" src='{{asset("posts/images/$post->img")}}' alt="">
            <!-- End Featured Image -->
