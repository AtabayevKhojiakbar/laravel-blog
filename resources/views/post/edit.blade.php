    ...
    <div class="container">
        ...
        <div class="d-flex">
            @if($errors->any())
                ...
                @endforeach
            @endif
            <form method="post" action="{{route('adminpost.update',$post->id)}}" enctype="multipart/form-data" class="w-100 m-3 mt-0 p-5" >
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="text" id="texti" required cols="100" rows="10" class="form-control">
                        {{$post->text}}
                    </textarea>
                </div>
                <div class="mb-3">
